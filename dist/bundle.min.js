...
var uniq=require("uniq"),extend=require("extend"),EmoticonBox=React.createClass({displayName:"EmoticonBox",loadDataFromServer:function(){fetch(this.props.dataSource).then(function(e){return e.json()}).then(function(e){this.setState({data:e.list})}.bind(this))["catch"](function(e){console.log("request failed",e)})},componentDidMount:function(){this.loadDataFromServer()},getInitialState:function(){return{searchText:"",data:[]}},handleSearch:function(){this.setState({searchText:this.refs.searchBox.getDOMNode().value})},render:function(){var e=[],t=this.state.searchText.trim();return this.state.data.forEach(function(n){(!t||n.tag.split(" ").indexOf(t)>=0)&&Array.prototype.push.apply(e,n.yan)}),React.createElement("div",{className:"emoticon-box"},React.createElement("input",{type:"text",className:"search-box",ref:"searchBox",placeholder:"关键词搜索，如: 掀桌",onChange:this.handleSearch,value:this.state.searchText}),React.createElement(EmoticonList,{emoticons:uniq(e),onSelect:this.props.onSelect}))}}),EmoticonList=React.createClass({displayName:"EmoticonList",handleSelect:function(e){var t=e.target.textContent||e.target.innerText;this.props.onSelect(t)},render:function(){var e=this.props.emoticons.map(function(e){return React.createElement("li",{className:"emoticon",onClick:this.handleSelect,key:e},e)}.bind(this));return React.createElement("ul",{className:"emoticon-list"},e)}}),Yan={init:function(e,t){t=extend({dataSource:"https://cdn.rawgit.com/turingou/o3o/master/yan.json",onSelect:function(){},closeOnSelect:!0},t);var n=null,a=t.onSelect;t.onSelect=function(e){n&&t.closeOnSelect&&n.close(),a(e)};var o=document.createElement("div");React.render(React.createElement(EmoticonBox,React.__spread({},t)),o),n=new Drop({target:e,classes:"drop-theme-arrows-bounce",content:o,position:"top center",constrainToWindow:!0,openOn:"click"})}};module.exports=Yan;
